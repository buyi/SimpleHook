...
public class MainActivityJava extends Activity {
    ...
    static {
        System.loadLibrary("hookdemo2java");
    }
    ...
    public void demo()
    {
         ...
         */
        hook(MainActivityJava.class, "test", "(Ljava/lang/String;J[I)Ljava/lang/String;", new Handler()
        {
            @Override
            public void before(Object instance, Object[] params)
            {
         ...
         */
        hook(MainActivityJava.class, "staticTest", "(Ljava/lang/String;Ljava/lang/Long;[I)Ljava/lang/String;", new Handler()
        {
            @Override
            public void before(Object instance, Object[] params)
            {
